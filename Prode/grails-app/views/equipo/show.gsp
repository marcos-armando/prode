	...
	<body>
		...
		<div id="show-equipo" class="content scaffold-show" role="main">
			...
			<ol class="property-list equipo">
				...
				<g:if test="${equipoInstance?.apodo}">
				<li class="fieldcontain">
					<span id="apodo-label" class="property-label"><g:message code="equipo.apodo.label" default="Apodo" /></span>
					
						<span class="property-value" aria-labelledby="apodo-label"><g:fieldValue bean="${equipoInstance}" field="apodo"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${equipoInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
